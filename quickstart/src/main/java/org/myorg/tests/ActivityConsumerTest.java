...
class ActivityConsumerTest {
    private UidFunctionProcess uidFunctionProcess;
    ...
    public void testIpAggregate() throws Exception {
        ...
        assertEquals(new Alert(FraudulentPatterns.MANY_EVENTS_FOR_IP), aggregator.getResult(new Tuple2<String, Integer>("testIP",3)));
    }
